...
/*
interfaces are behaviour.
set of methods.package main
they are not concrete type.
they are not real.
*/
/*"Polymorphism means that you write a certain program
and it behaves differently depending on the data that it operates on." - Tom Kurtz (inventor of BASIC)
